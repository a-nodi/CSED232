...
// gradient::gradient() : artist() { }

gradient::gradient(int _width, int _height, const std::vector<int>& _image_data) : artist(_width, _height, _image_data) { }

gradient::~gradient() { }

char gradient::mapper(int x, int y) {
	/*
	* The function that performs "sobelx" operation and "sobely" operation using pixel value of given corrdinate
	*
